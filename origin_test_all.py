...
from origin_cifar import CIFAR, CIFARModel
from setup_mnist import MNIST, MNISTModel
from setup_inception import ImageNet, InceptionModel

from l2_attack import CarliniL2
from origin_l2_attack_black import BlackBoxL2
...
def main(args):
    ...
    with tf.Session() as sess:
        ...
        if args['dataset'] == "mnist":
            ...
            #data, model = CIFAR(), CIFAR_WIDE("models/wide_resnet", sess, use_log)
        ...
        print(' origin accuracy : ', 100.0*origin_correct/all_true_ids.size)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--level", default=15, type=int, help=" encoder level")
    args = vars(parser.parse_args())
    # add some additional parameters
    # learning rate
    args['lr'] = 1e-2
    args['inception'] = False
    args['use_tanh'] =True ##llj
